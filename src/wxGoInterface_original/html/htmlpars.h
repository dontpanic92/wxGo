...
/*
//FIXME: SWIG will not generate %extend-ed functions for derived classes.
%extend {
    void DoParsing(int begin_pos, int end_pos) {
        wxString::const_iterator begin_iter = self->GetSource()->begin() + begin_pos;
        wxString::const_iterator end_iter = self->GetSource()->begin() + end_pos;
        self->DoParsing(begin_iter, end_iter);
    }
}
*/
